...
do
	...
	sbatch --time 3000 --job-name ${BASE_NAME}_${MODEL_ID} Lk_training.sh ${BASE_NAME} ${MODEL_ID} ${NUM_EPOCHS} ${DATASET} ${VOCAB_FILE} ${LEARNING_RATE} >> ${BASE_NAME}_training_ids.txt
done
