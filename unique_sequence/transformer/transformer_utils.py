...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, n_head, d_model, d_k, d_v, dropout=0.1):
        ...
        self.attention = ScaledDotProductAttention(temp=np.power(d_k, 0.5))
...
class Decoder(nn.Module):
    ...
    def forward(self, tgt_seq, tgt_pos, src_seq, enc_output, return_attns=False):
        # tgt_seq - sequence of tokens that are the targets to this Decoder
        # tgt_pos - listing the indices of the tokens in tgt_seq
...
class Transformer(nn.Module):
    ...
    def __init__(
            ...
            n_layers=6, n_head=8, d_k=64, d_v=64, dropout=0.0,
